...
<div style="max-width:640px">
    <div style="margin-bottom:20px">
        ...
        <h2 style="font-size:1.1rem;font-weight:700;color:#1e293b;margin:8px 0 2px">Novo Setor</h2>
        <p style="font-size:.8rem;color:#64748b;margin:0">Vincule o setor a uma unidade da empresa.</p>
    </div>
