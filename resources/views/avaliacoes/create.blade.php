<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nova Avaliação de Risco</h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white shadow sm:rounded-lg p-6">
                ...
                <p class="mt-2 text-sm text-gray-600">{{ $risco->ghe->nome }} • {{ $risco->riscoTipo->categoria }} / {{ $risco->riscoTipo->nome }} • {{ $risco->agente }}</p>
            </div>
