...
<div style="max-width:640px">
    <div style="margin-bottom:20px">
        ...
        <h2 style="font-size:1.1rem;font-weight:700;color:#1e293b;margin:8px 0 0">Editar Empresa</h2>
    </div>
    <div style="background:#fff;border-radius:10px;border:1px solid #e2e8f0;padding:24px">
        <form method="POST" action="{{ route('admin.empresas.update', $empresa) }}">
            ...
            <div style="display:flex;gap:10px;margin-top:24px;padding-top:20px;border-top:1px solid #f1f5f9">
                <button type="submit"
                    style="background:#3b82f6;color:#fff;padding:9px 20px;border-radius:7px;font-size:.85rem;font-weight:600;border:none;cursor:pointer">Salvar Alterações</button>
                <a href="{{ route('admin.empresas.index') }}"
